...
public class CircularConvolutionFFT {
   ...
   */
  public static ArrayList<Complex> fftCircularConvolution(ArrayList<Complex> a, ArrayList<Complex> b) {
      ...
      ArrayList<Complex> convolved = new ArrayList<>();
     ...
     */
    private static void padding(ArrayList<Complex> x, int newSize) {
        if (x.size() < newSize) {
