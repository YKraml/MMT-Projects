...
public class AliquotSum {
	...
	public static int getAliquotSum(int n) {
		 ...
		 * before the root. Ex- Factors of 100 are 1, 2, 4, 5, 10, 20, 25, 50 and 100.
		 * Root of 100 is 10. So factors before 10 are 1, 2, 4 and 5. Now by dividing
		 * 100 by each factor before 10 we get: 100/1 = 100, 100/2 = 50, 100/4 = 25 and
		 * 100/5 = 20 So we get 100, 50, 25 and 20 which are factors of 100 after 10
		 */
		...
		// if n is a perfect square then its root was added twice in above loop, so
		// subtracting root
		// from sum
		if (root == (int) root)
			sum -= root;
